...
class MeleeBot:
    ...
    def get_reward(self, state, prevstate):
        ...
        reward += (prevstate[3] - state[3]) * 150
        # if state[4] > -15 and state[4] < 15:
        #     reward -= 2
        #     if state[5] > -15 and state[5] < 15:
        #         reward +=2
        return reward
    ...
    def update_state(self, ai_list, opp_list):
        ...
        state[3] = ai_list[0]/10    # Mapper [-200, 200] til [-20, 20]
        state[4] = opp_list[0]/10   # Mapper [-200, 200] til [-20, 20]
        return state
